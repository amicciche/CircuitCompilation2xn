...
function test_CSS_naive_refactor()
    name = "LDPC1"
    error_rates = exp10.(range(-5,-1.5,length=40))
...
function calculate_naive_average_shifts(n=120, wr=6, wc=8, samples=10)
...
function calculate_shor_average_shifts(n=120, wr=6, wc=8, samples=10)
...
#H = S"ZZZZ______;Z___ZZZ___;_Z__Z__ZZ_;__Z__Z_Z_Z;___Z__Z_ZZ"